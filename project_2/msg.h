...
#define PROTOCOL_H
    ...
    int msg_Parse_ReplyResponse(char* in_msg, Article* out_article);

    int msg_Build_ErrorResponse(char* out_msg, char* error_string);
    int msg_Build_Post(char* out_msg, char* author, char* title, char* contents);
