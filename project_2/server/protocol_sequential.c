...
void protoSequential_Read(ServerGroup* server_group, int socket, char* msg_rcvd)
{
    int count;
...
void protoSequential_Reply(ServerGroup* server_group, int socket, char* msg_rcvd)
{
    ArticleDatabase db_snapshot;
    char error_msg[4096];
