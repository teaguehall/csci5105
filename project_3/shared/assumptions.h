...
#define MAX_PEERS_IN_NETWORK    64                          // maximum number of peers allowed in network at one time
#define MAX_FILES_PER_PEER      64                          // maximum number of files that each node can offer
