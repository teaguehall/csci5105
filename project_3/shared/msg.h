...
#define MSG_TYPE_DISCOVER_REQUEST           0x2000
// message structure:
// - header (see structure above)

#define MSG_TYPE_DISCOVER_RESPONSE          0x2001
// message structure:
// - header (see structure above)
...
#define MSG_TYPE_FIND_REQUEST               0x3000
// message structure:
// - header (see structure above)
// - file name (null terminated string)

#define MSG_TYPE_FIND_RESPONSE              0x3001
// message structure:
// - header (see structure above)
// - number of peers (uint32 4-bytes)
//      - peer address (null terminated string)
//      - peer port (uint32 4-bytes)
//      - latitude (int32 4-bytes)
//      - longitude (int32 4-bytes)

#define MSG_TYPE_UPDATE_LIST_REQUEST        0x4000
// message structure:
// - header (see structure above)
// - peer address (null terminated string)
// - peer port (uint32 4-bytes)
...
#define MSG_TYPE_UPDATE_LIST_RESPONSE       0x4001
// message structure:
// - header (see structure above)

#define MSG_TYPE_PING_REQUEST               0x5000
// message structure:
// - header (see structure above)
// - peer address (null terminated string)
// - peer port (uint32 4-bytes)
...
#define MSG_TYPE_PING_RESPONSE              0x5001
// message structure:
// - header (see structure above)
// - recognized (uint32 4-bytes)

#define MSG_TYPE_GET_LOAD_REQUEST           0x6000
// message structure:
// - header (see structure above)

#define MSG_TYPE_GET_LOAD_RESPONSE          0x6001
// message structure:
// - header (see structure above)
// - loads (uint32 4-bytes)

#define MSG_TYPE_DOWNLOAD_REQUEST           0x7000
// message structure:
// - header (see structure above)
// - file name (null terminated string)
